...
| P25 VFO FIR | Fixture verified | expert | no | 63-tap Hamming sinc at 6 kHz on IQ before the discriminator; not a P25 voice decoder. |
...
| P25 TSBK observer | Fixture verified | expert | no | Group-voice-grant TSBK recovered from C4FM IQ; encrypted calls labeled only; no invented talkgroups. |
...
| BLE advertising | Fixture verified | normal | no | Recorded GFSK IQ recovers advertising address, name, CRC-24, and RSSI. |
