...
pub fn slices() -> Vec<ProtocolSlice> {
    vec![
        ...
        slice_verified("lora-mesh", "LoRa mesh and Modbus", "Regional plan selected explicitly (US915/EU868 documented plans only)", 915_000_000, 125_000, 1_000_000, "LoRa up-chirp preamble and SFD", "CSS SF8 125 kHz", "Implicit-header CSS fixture; Hamming FEC not claimed", "PHY recovery plus Modbus CRC-16; mesh/LoRaWAN MIC never decrypted", "lora.mesh.v1: protocol, address, message_type, content, encryption", "fixtures/recorded-iq/lora-meshtastic-hello.iq.json", "Packet table with MeshCore/Meshtastic/Reticulum/Modbus families; encrypted bodies stay opaque", "native CSS PHY -> mesh/Modbus/LoRaWAN identifier"),
