...
const ADAPTATION_TEMPLATES: &[AdaptationTemplate] = &[
    ...
    AdaptationTemplate {
        ...
        native_rust: true,
        depmanager_name: None,
        notes: "Rust GMSK decoder runs on the AIS scan range; AIS-catcher is an optional sidecar.",
    },
    AdaptationTemplate {
        catalog_id: "aprs",
        name: "APRS / AX.25",
        ...
        notes: "Native AFSK path runs on APRS 2m; direwolf adapts via stdin audio when piped.",
    },
    AdaptationTemplate {
        catalog_id: "pocsag",
        name: "POCSAG / FLEX",
        ...
        notes: "Native POCSAG decoder runs on pager ranges; multimon-ng adapts for FLEX.",
    },
    AdaptationTemplate {
        catalog_id: "rds",
        name: "Broadcast RDS",
    ...
    AdaptationTemplate {
        ...
        notes: "Rust UAT framing is fixture-verified; dump978-fa is an optional IQ stdin adapter.",
    },
    AdaptationTemplate {
        catalog_id: "acars",
        name: "ACARS",
        ...
        notes: "Native ACARS framing runs on the ACARS scan range; acarsdec remains a file-IQ adapter.",
    },
    AdaptationTemplate {
        catalog_id: "vdl2",
        name: "VDL Mode 2",
        ...
        notes: "Native HDLC/AVLC framing runs on the VDL2 scan range; dumpvdl2 remains a file-IQ adapter.",
    },
    AdaptationTemplate {
        catalog_id: "rtl433",
    ...
    AdaptationTemplate {
        ...
        native_rust: true,
        depmanager_name: None,
        notes: "Native RTTY demod runs on the RTTY 20m scan range.",
    },
    AdaptationTemplate {
        catalog_id: "navtex",
        name: "NAVTEX",
    ...
    AdaptationTemplate {
        ...
        notes: "dsd-fme stdin discriminator feed is wired when the DSD pack is enabled; per-mode recorded-IQ e2e remains open.",
    },
    AdaptationTemplate {
        catalog_id: "p25",
        name: "P25",
